webpackJsonp([11,8],Array(320).concat([
/* 320 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Address = function (_React$Component) {
		...
		function Address(props) {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Address).call(this, props));

			window.scrollTo(0, 0);
			_this2.state = { address_list_data: [{}] };
			return _this2;
		}
		...
		_createClass(Address, [{
			...
			value: function componentDidMount() {
				var _this = this;
				(0, _fetch.fetch_data_get)("/api/get_address_list_data", { apiUser: localStorage.sc_client_api_user, apiKey: localStorage.sc_client_api_key }).then(function (result) {
					var address_list_data = [];
					result.body.address_list_data.map(function (ele, key) {
			...
			key: "render",
			value: function render() {
				var columns = [{ title: "列表名称", dataIndex: "name", key: "name", render: function render(text) {
						return _react2.default.createElement(
							"a",
							{ href: "#" },
							text
						);
					} }, { title: "别称地址", dataIndex: "address", key: "address" }, { title: "列表描述", dataIndex: "description", key: "description" }, { title: "列表地址数", dataIndex: "memberCount", key: "memberCount" }, { title: "更新时间", dataIndex: "gmtUpdated", key: "gmtUpdated" }, { title: "操作", key: "operation", render: function render(text, record) {
						return _react2.default.createElement(
							"span",
							null,
							_react2.default.createElement(
								_reactRouter.Link,
								{ to: "/send_email/address_datail/" + record.address },
								"编辑"
							),
				...
				return _react2.default.createElement(
					"div",
					{ className: "SE_address_wrap" },
					_react2.default.createElement(
						"div",
						{ className: "SE_address" },
						_react2.default.createElement(_table2.default, { columns: columns, dataSource: this.state.address_list_data })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".SE_address_wrap {\n  padding-top: 40px; }\n  .SE_address_wrap .SE_address .ant-table td {\n    max-width: 80px; }\n", ""]);
